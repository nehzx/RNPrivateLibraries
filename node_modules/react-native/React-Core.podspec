...
header_subspecs = {
  'ARTHeaders'                  => 'node_modules/react-native/Libraries/ART/**/*.h',
...
Pod::Spec.new do |s|
  ...
  s.subspec "Default" do |ss|
    ss.source_files           = "node_modules/react-native/React/**/*.{c,h,m,mm,S,cpp}"
    ss.exclude_files          = "node_modules/react-native/React/CoreModules/**/*",
    ...
    ss.ios.exclude_files      = "node_modules/react-native/React/**/RCTTV*.*"
    ss.tvos.exclude_files     = "node_modules/react-native/React/Modules/RCTClipboard*",
                                "node_modules/react-native/React/Views/RCTDatePicker*",
                                "node_modules/react-native/React/Views/RCTPicker*",
                                "node_modules/react-native/React/Views/RCTRefreshControl*",
                                "node_modules/react-native/React/Views/RCTSlider*",
                                "node_modules/react-native/React/Views/RCTSwitch*",
    ss.private_header_files   = "node_modules/react-native/React/Cxx*/*.h"
  end

  s.subspec "DevSupport" do |ss|
    ss.source_files = "node_modules/react-native/React/DevSupport/*.{h,mm,m}",
                      "node_modules/react-native/React/Inspector/*.{h,mm,m}"
