...
var mGetClosestPoint = mocked(getClosestPoint);
var mGetPrecision = mocked(getPrecision);
describe('ensureValuePrecision', function () {
  ...
  it('should return closest point if it is a finite number and step is 0', function () {
    ...
    var actual = ensureValuePrecision(1, _objectSpread(_objectSpread({}, baseProps), {}, {
      step: 0
    }));
