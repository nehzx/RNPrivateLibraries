...
describe('Loading', function () {
  ...
  describe('snapshot', function () {
    it('renders correctly', function () {
      var wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(Loading, {
        visible: true
      }, "foo"));
      expect(wrapper).toMatchSnapshot();
    });
    it('visible change true', function () {
      var wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(Loading, null));
      wrapper.setProps({
        visible: true
      });
      expect(wrapper).toMatchSnapshot();
  ...
  it('static function pass params', function () {
    jest.useFakeTimers();
    Loading.show({
      content: /*#__PURE__*/_react.default.createElement("div", null, "loading...")
    });
    jest.runAllTimers();
  ...
  it('should auto close loading if stay time greater than 0', function () {
    ...
    var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(Loading, {
      visible: true,
      stayTime: 100
    }));
  ...
  it('should do nothing after close if someone force remove the zarm loading dom', function () {
    ...
    var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(Loading, null));
    wrapper.invoke('afterClose')();
