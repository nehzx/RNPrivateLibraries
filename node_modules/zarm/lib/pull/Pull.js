...
var Pull = /*#__PURE__*/function (_PureComponent) {
  ...
  function Pull(props) {
    ...
    _this.addEvent = function () {
      ...
      _events.default.on(_this.wrap, 'scroll', _this.throttledScroll);

      _events.default.on(_this.wrap, 'touchstart', _this.wrapTouchstart);

      _events.default.on(_this.wrap, 'touchmove', _this.wrapTouchmove);

      _events.default.on(_this.wrap, 'touchend', _this.wrapTouchEnd);
    };

    _this.removeEvent = function () {
      _events.default.off(_this.wrap, 'scroll', _this.throttledScroll);

      _events.default.off(_this.wrap, 'touchstart', _this.wrapTouchstart);

      _events.default.off(_this.wrap, 'touchmove', _this.wrapTouchmove);

      _events.default.off(_this.wrap, 'touchend', _this.wrapTouchEnd);
    };
      ...
      switch (refreshState) {
        case _PropsType.REFRESH_STATE.pull:
          return /*#__PURE__*/_react.default.createElement("div", {
            ...
            loading: false,
            percent: percent
          }), /*#__PURE__*/_react.default.createElement("span", null, locale.pullText));
        ...
        case _PropsType.REFRESH_STATE.drop:
          return /*#__PURE__*/_react.default.createElement("div", {
            ...
            loading: false,
            percent: 100
          }), /*#__PURE__*/_react.default.createElement("span", null, locale.dropText));
        ...
        case _PropsType.REFRESH_STATE.loading:
          return /*#__PURE__*/_react.default.createElement("div", {
            ...
            type: "spinner"
          }), /*#__PURE__*/_react.default.createElement("span", null, locale.loadingText));

        case _PropsType.REFRESH_STATE.success:
          return /*#__PURE__*/_react.default.createElement("div", {
            className: cls
          }, /*#__PURE__*/_react.default.createElement(_icons.SuccessCircle, {
            theme: "success"
          }), /*#__PURE__*/_react.default.createElement("span", null, locale.successText));

        case _PropsType.REFRESH_STATE.failure:
          return /*#__PURE__*/_react.default.createElement("div", {
            className: cls
          }, /*#__PURE__*/_react.default.createElement(_icons.WarningCircle, {
            theme: "danger"
          }), /*#__PURE__*/_react.default.createElement("span", null, locale.failureText));
    ...
    _this.renderLoad = function () {
      ...
      switch (loadState) {
        ...
        case _PropsType.LOAD_STATE.complete:
          return /*#__PURE__*/_react.default.createElement("div", {
            className: cls
          }, /*#__PURE__*/_react.default.createElement("span", null, locale.completeText));
