...
Pod::Spec.new do |s|
  ...
  s.subspec "turbomodule" do |ss|
    ...
    ss.subspec "core" do |sss|
      sss.source_files = "node_modules/react-native/ReactCommon/node_modules/react-native/ReactCommon/turbomodule/core/*.{cpp,h}",
                         "node_modules/react-native/ReactCommon/node_modules/react-native/ReactCommon/turbomodule/core/platform/ios/*.{mm,cpp,h}"
    end

    ss.subspec "samples" do |sss|
      sss.source_files = "node_modules/react-native/ReactCommon/node_modules/react-native/ReactCommon/turbomodule/samples/*.{cpp,h}",
                         "node_modules/react-native/ReactCommon/node_modules/react-native/ReactCommon/turbomodule/samples/platform/ios/*.{mm,cpp,h}"
